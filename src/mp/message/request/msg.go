...
func GetText(msg *message.MixedMessage) *Text {
	return &Text{
...
func GetImage(msg *message.MixedMessage) *Image {
	return &Image{
		MessageHeader: msg.MessageHeader,
		MsgId:         msg.MsgId,
		MediaId:       msg.MediaId,
...
func GetVoice(msg *message.MixedMessage) *Voice {
	return &Voice{
		MessageHeader: msg.MessageHeader,
		MsgId:         msg.MsgId,
		MediaId:       msg.MediaId,
...
func GetVideo(msg *message.MixedMessage) *Video {
	return &Video{
		MessageHeader: msg.MessageHeader,
		MsgId:         msg.MsgId,
		MediaId:       msg.MediaId,
...
func GetShortVideo(msg *message.MixedMessage) *ShortVideo {
	return &ShortVideo{
		MessageHeader: msg.MessageHeader,
		MsgId:         msg.MsgId,
		MediaId:       msg.MediaId,
...
func GetLocation(msg *message.MixedMessage) *Location {
	return &Location{
		MessageHeader: msg.MessageHeader,
		MsgId:         msg.MsgId,
...
func GetLink(msg *message.MixedMessage) *Link {
	return &Link{
		MessageHeader: msg.MessageHeader,
		MsgId:         msg.MsgId,
		Title:         msg.Title,
