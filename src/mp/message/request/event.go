...
const (
	...
	EventTypeView        = "VIEW"
	EventTypeTempSendOk  = "TEMPLATESENDJOBFINISH" // 模板消息收到后的推送事件
	EventLocationSelect  = "location_select"       //地理位置选择事件
)
...
func GetSubscribeEvent(msg *message.MixedMessage) *SubscribeEvent {
...
func GetUnsubscribeEvent(msg *message.MixedMessage) *UnsubscribeEvent {
...
func GetSubscribeByScanEvent(msg *message.MixedMessage) *SubscribeByScanEvent {
...
func GetScanEvent(msg *message.MixedMessage) *ScanEvent {
	return &ScanEvent{
		MessageHeader: msg.MessageHeader,
		Event:         msg.Event,
		EventKey:      msg.EventKey,
...
func GetLocationEvent(msg *message.MixedMessage) *LocationEvent {
